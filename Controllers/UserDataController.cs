...
namespace angularAsp.Controllers
{
    ...
    public class UserDataController : Controller
    {
        ...
        private static readonly UserDataController instance = new UserDataController();
        ...
        [HttpPost]
        public ActionResult<User[]> AddUsers([FromBody] User[] users)
        {
            Console.WriteLine($"Add: {JsonConvert.SerializeObject(users)}");
            Instance.AddUser(users);
            Instance.Broadcast();
